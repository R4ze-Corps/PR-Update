...
exports.default = localCreateResponder({
    ...
    async run(interaction) {
        try {
            _functions_1.sessoesUpar.set(interaction.user.id, { tipo: "REBAIXAMENTO" });
            const options = _functions_1.cargosRebaixamento.map(c => new discord_js_1.StringSelectMenuOptionBuilder()
                .setLabel(c.nome)
                .setValue(c.id)
                .setEmoji("📉"));
...
//# sourceMappingURL=btn_rebaixar.js.map